...
def main():
    ...
    model_config["num_hidden_layers"] = training_args.num_hidden_layers
    ...
    if not dpo_config.reference_free and not dpo_config.lora:
        ...
        ref_model_config["num_hidden_layers"] = training_args.num_hidden_layers
