...
<a name="使用 Trainer 启动 CLUE 分类任务"></a>
...
Grid Search 需要在 GPU 环境下进行，需要注意的是 C<sup>3</sup> 任务需要显存大于 16 GB，最好是在显存 32 GB 的环境下启动。
