...
class MistralModelTester:
    def __init__(
        ...
        self.parent: MistralModelTest = parent
    ...
    def create_and_check_model(
        self, config: MistralConfig, input_ids, input_mask, sequence_labels, token_labels, choice_labels
    ):
...
class MistralModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(self, config_class=MistralConfig, vocab_size=256, hidden_size=24)
